...
$admin_links = array(
'Guided tour' => array('name' => __('Guided tour', 'contact-manager')),
...
'answers' => array('name' => __('Answers', 'contact-manager')),
...
'registration-to-affiliate-program' => array('name' => __('Registration to the affiliate program', 'contact-manager')),
...
$autoresponders_integration_modules = array(); foreach (contact_autoresponders() as $key => $value) {
if (isset($value['display_function'])) { $autoresponders_integration_modules[str_replace('_', '-', kleor_format_nice_name($key))] = array('name' => $key); } }
...
'message-notification-email' => array('name' => __('Message notification email', 'contact-manager')),
'autoresponders' => array('name' => __('Autoresponders', 'contact-manager')),
'autoresponders-integration' => array('name' => __('Autoresponders integration', 'contact-manager'), 'modules' => $autoresponders_integration_modules),
'registration-as-a-client' => array('name' => __('Registration as a client', 'contact-manager')),
'registration-to-affiliate-program' => array('name' => __('Registration to the affiliate program', 'contact-manager')),
'membership' => array('name' => __('Membership', 'contact-manager')),
'wordpress' => array('name' => __('WordPress', 'contact-manager')),
