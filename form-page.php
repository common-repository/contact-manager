...
echo '<div class="updated-notice"><p><strong>'.($is_category ? __('Category deleted.', 'contact-manager') : __('Form deleted.', 'contact-manager')).'</strong></p></div>
<script>setTimeout(\'window.location = "admin.php?page=contact-manager-forms'.($is_category ? '-categories' : '').'"\', 2000);</script>'; } ?>
...
<p style="font-size: 1.2em;"><strong style="color: #c00000;"><?php echo ($is_category ? __('Do you really want to permanently delete this category?', 'contact-manager') : __('Do you really want to permanently delete this form?', 'contact-manager')); ?></strong></p>
...
echo '<div class="updated-notice"><p><strong>'.(isset($_GET['id']) ? ($is_category ? __('Category updated.', 'contact-manager') : __('Form updated.', 'contact-manager')) : ($is_category ? __('Category saved.', 'contact-manager') : __('Form saved.', 'contact-manager'))).'</strong></p></div>
'.(isset($_GET['id']) ? '' : '<script>setTimeout(\'window.location = "admin.php?page=contact-manager-forms'.($is_category ? '-categories' : '').'"\', 2000);</script>'); } ?>
<form method="post" name="<?php echo esc_attr($_GET['page']); ?>" id="<?php echo esc_attr($_GET['page']); ?>" action="<?php echo esc_attr($_SERVER['REQUEST_URI']); ?>" onsubmit="return kleor_validate_form(this);">
<?php wp_nonce_field($_GET['page']); ?>
<?php contact_manager_pages_menu($back_office_options); ?>
<?php if ($error != '') { echo '<p style="color: #c00000;">'.$error.'</p>'; } ?>
...
<script>
function kleor_update_category_top_description(category) {
...
kleor_update_category_top_description(<?php echo (int) $_POST['category_id']; ?>);
</script>
...
<td><select name="category_id" id="category_id" onchange="kleor_update_category_top_description(this.value); kleor_update_form(this.form);">
...
echo '<option value="'.$category->id.'"'.($_POST['category_id'] == $category->id ? ' selected="selected"' : '').'>'.kleor_do_shortcode($category->name).'</option>'."\n"; } } ?>
</select>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="name" id="name" rows="1" cols="50"<?php if ((!isset($_GET['id'])) && (isset($_POST['submit'])) && ($_POST['name'] == '')) { echo ' placeholder="'.__('This field is required.', 'contact-manager').'"'; } ?> onchange="kleor_update_form(this.form);"><?php echo $_POST['name']; ?></textarea>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="keywords" id="keywords" rows="1" cols="75" onchange="kleor_update_form(this.form);"><?php echo $_POST['keywords']; ?></textarea><br />
...
<td><input class="date-pick" type="text" name="date" id="date" size="20" value="<?php echo ($_POST['date'] != '' ? $_POST['date'] : $current_date); ?>" onchange="kleor_update_form(this.form);" /></td></tr>
...
<td><textarea style="padding: 0 0.25em; '.($rows == 1 ? 'height: 1.75em; ' : '').'width: 75%;" name="custom_field_'.$key.'" id="custom_field_'.$key.'" rows="'.$rows.'" cols="75" onkeyup="kleor_update_links(this.form);" onchange="kleor_update_links(this.form);">'.htmlspecialchars($field_value).'</textarea>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 75%;" name="gift_download_url" id="gift_download_url" rows="1" cols="75" onkeyup="kleor_update_links(this.form);" onchange="kleor_update_links(this.form);"><?php echo $_POST['gift_download_url']; ?></textarea> 
<span style="vertical-align: 25%;"><span id="gift-download-url-link"><?php $urls_fields[] = 'gift_download_url'; $url = htmlspecialchars(contact_form_data(array(0 => 'gift_download_url', 'part' => 1, $attribute => (isset($_GET['id']) ? $_GET['id'] : 0)))); if ($url != '') { echo '<a '.$urls_fields_links_markup.' href="'.$url.'">'.__('Link', 'contact-manager').'</a>'; } ?></span>
<?php if (current_user_can('upload_files')) { echo '<br /><a class="select-file" data-id="gift_download_url" '.$urls_fields_links_markup.' href="media-new.php" title="'.__('After the upload, you will just need to copy and paste the URL of the file in this field.', 'contact-manager').'">'.__('Upload a file', 'contact-manager').'</a>'; } ?></span><br />
<span class="description"><?php _e('You can enter several URLs.', 'contact-manager'); ?> <a <?php echo $documentations_links_markup; ?> href="https://www.kleor.com/contact-manager/#multiple-urls"><?php _e('More informations', 'contact-manager'); ?></a> 
<a <?php echo $documentations_links_markup; ?> href="https://www.kleor.com/contact-manager/#urls-encryption"><?php _e('How to encrypt a download URL?', 'contact-manager'); ?></a></span></td></tr>
...
<span class="description"><?php _e('You can offer a gift to senders.', 'contact-manager'); ?> <a <?php echo $documentations_links_markup; ?> href="https://www.kleor.com/contact-manager/#gift"><?php _e('More informations', 'contact-manager'); ?></a></span></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th><td><input type="submit" class="button-secondary" name="submit" value="<?php echo (isset($_GET['id']) ? __('Update', 'contact-manager') : __('Save', 'contact-manager')); ?>" /></td></tr>
</tbody></table>
</div></div>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="maximum_messages_quantity_per_sender" id="maximum_messages_quantity_per_sender" rows="1" cols="25" onchange="kleor_update_form(this.form);"><?php echo (!is_numeric($_POST['maximum_messages_quantity_per_sender']) ? '' : $_POST['maximum_messages_quantity_per_sender']); ?></textarea>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="displays_count" id="displays_count" rows="1" cols="25" onchange="kleor_update_form(this.form);"><?php echo (int) $_POST['displays_count']; ?></textarea></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="messages_count" id="messages_count" rows="1" cols="25" <?php if (isset($_GET['id'])) { echo 'onkeyup="kleor_update_links(this.form);" '; } ?>onchange="<?php if (isset($_GET['id'])) { echo 'kleor_update_links(this.form); '; } ?>kleor_update_form(this.form);"><?php echo (int) $_POST['messages_count']; ?></textarea>
...
<input type="submit" class="button-tertiary" name="count_messages" value="'.__('Re-count the messages', 'contact-manager').'" />
<input type="submit" class="button-tertiary" name="count_messages_of_all_forms" value="'.__('Re-count the messages of all forms', 'contact-manager').'" />'; } ?></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th><td><input type="submit" class="button-secondary" name="submit" value="<?php echo (isset($_GET['id']) ? __('Update', 'contact-manager') : __('Save', 'contact-manager')); ?>" /></td></tr>
</tbody></table>
</div></div>
<?php } ?>
...
<a <?php echo $documentations_links_markup; ?> href="https://www.kleor.com/contact-manager/#forms-creation"><?php _e('How to create a form?', 'contact-manager'); ?></a><br />
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="maximum_messages_quantity" id="maximum_messages_quantity" rows="1" cols="25" onchange="kleor_update_form(this.form);"><?php echo ($_POST['maximum_messages_quantity'] === 'unlimited' ? 'i' : $_POST['maximum_messages_quantity']); ?></textarea>
...
<span class="description"><?php _e('For most autoresponders, you must enter the list ID.', 'contact-manager'); ?> <a <?php echo $documentations_links_markup; ?> href="https://www.kleor.com/contact-manager/#autoresponders"><?php _e('More informations', 'contact-manager'); ?></a><br />
<?php _e('Leave this field blank to apply the default option.', 'contact-manager'); ?></span></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th><td><input type="submit" class="button-secondary" name="submit" value="<?php echo (isset($_GET['id']) ? __('Update', 'contact-manager') : __('Save', 'contact-manager')); ?>" /></td></tr>
</tbody></table>
</div></div>
...
<span class="description"><a <?php echo $documentations_links_markup; ?> href="https://www.kleor.com/contact-manager/#registration-as-a-client"><?php _e('More informations', 'contact-manager'); ?></a></span></td></tr>
...
<span class="description"><a <?php echo $documentations_links_markup; ?> href="https://www.kleor.com/contact-manager/#registration-to-affiliate-program"><?php _e('More informations', 'contact-manager'); ?></a></span></td></tr>
...
<span class="description"><a <?php echo $documentations_links_markup; ?> href="https://www.kleor.com/contact-manager/#membership"><?php _e('More informations', 'contact-manager'); ?></a></span></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 50%;" name="sender_members_areas" id="sender_members_areas" rows="1" cols="50" onkeyup="kleor_update_links(this.form); kleor_update_form(this.form);" onchange="kleor_update_links(this.form); kleor_update_form(this.form);"><?php echo $_POST['sender_members_areas']; ?></textarea>
...
<td><textarea style="float: left; margin-right: 1em; width: 50%;" name="sender_members_areas_modifications" id="sender_members_areas_modifications" rows="2" cols="50" onchange="kleor_update_form(this.form);"><?php echo $_POST['sender_members_areas_modifications']; ?></textarea>
<span class="description"><?php _e('You can offer a temporary access, and automatically modify the list of members areas to which the member can access when a certain date is reached.', 'contact-manager'); ?>
 <a <?php echo $documentations_links_markup; ?> href="https://www.kleor.com/membership-manager/documentation/#members-areas-modifications"><?php _e('More informations', 'contact-manager'); ?></a><br />
<?php _e('Leave this field blank to apply the default option.', 'contact-manager'); ?></span></td></tr>
...
<span class="description"><a <?php echo $documentations_links_markup; ?> href="https://www.kleor.com/contact-manager/#wordpress"><?php _e('More informations', 'contact-manager'); ?></a></span></td></tr>
...
<span class="description"><a <?php echo $documentations_links_markup; ?> href="https://www.kleor.com/contact-manager/#custom-instructions"><?php _e('More informations', 'contact-manager'); ?></a></span></td></tr>
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="commission_amount" id="commission_amount" rows="1" cols="25" onchange="kleor_update_form(this.form);"><?php echo $_POST['commission_amount']; ?></textarea> <span style="vertical-align: 25%;"><?php echo $currency_code; ?></span> 
...
<td><textarea style="padding: 0 0.25em; height: 1.75em; width: 25%;" name="commission2_amount" id="commission2_amount" rows="1" cols="25" onchange="kleor_update_form(this.form);"><?php echo $_POST['commission2_amount']; ?></textarea> <span style="vertical-align: 25%;"><?php echo $currency_code; ?></span> 
<span class="description" style="vertical-align: 25%;"><?php _e('Leave this field blank to apply the default option.', 'contact-manager'); ?></span></td></tr>
<tr style="vertical-align: top;"><th scope="row" style="width: 20%;"></th>
<td><input type="submit" class="button-secondary" name="submit" value="<?php echo (isset($_GET['id']) ? __('Update', 'contact-manager') : __('Save', 'contact-manager')); ?>" /></td></tr>
</tbody></table>
...
foreach (array(
'displays_count',
'messages_count') as $field) { $fields[] = $field; $strings[$field] = "kleor_format_integer(this.value)"; } }
...
else if (fields[i] == "gift_download_url") { element.innerHTML = \'<a '.$urls_fields_links_markup.' href="\'+url.replace(/[&]/g, "&amp;")+\'">'.__('Link', 'contact-manager').'</a>\'; }
...
if (element) {
var value = kleor_format_integer(form["messages_count"].value); if (value == "") { value = 0; }
...
echo 'function kleor_validate_form(form) {
var error = false;
...
jQuery(".select-file").html("<?php _e('Click here to select a file instead of entering a URL.', 'contact-manager'); ?>");
jQuery(".select-file").attr("title", "");
...
title: "<?php _e('Select File', 'contact-manager'); ?>",
button: { text: "<?php _e('Select this file', 'contact-manager'); ?>"},
multiple: false});
...
element.setAttribute("data-empty", "no");
element.style.color = "";
kleor_update_links(document.forms["<?php echo $_GET['page']; ?>"]); });
media_selector.open(); }); } });
</script>
<?php }