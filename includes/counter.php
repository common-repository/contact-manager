...
$content = explode('[after]', kleor_do_shortcode($content));
...
remove_shortcode($tag); add_shortcode($tag, function($atts) use($tag) { $atts = (array) $atts; $atts["data"] = $tag; return contact_counter_tag($atts); }); }
...
$content = (isset($content[$k]) ? kleor_do_shortcode($content[$k]) : '');
